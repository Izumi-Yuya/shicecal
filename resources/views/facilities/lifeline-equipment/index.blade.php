<!-- ライフライン設備カード -->
<div class="card facility-info-card detail-card-improved mb-4" data-section="lifeline_equipment">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-outline-secondary btn-sm comment-toggle" 
                ...
                title="コメントを表示/非表示"
                aria-label="ライフライン設備のコメントを表示または非表示にする"
                aria-expanded="false"
                aria-controls="comment-section-lifeline_equipment">
            <i class="fas fa-comment" aria-hidden="true"></i>
            <span class="comment-count" data-section="lifeline_equipment" aria-label="コメント数">0</span>
        </button>
    </div>
    <div class="card-body">
        <!-- ライフライン設備サブタブナビゲーション -->
