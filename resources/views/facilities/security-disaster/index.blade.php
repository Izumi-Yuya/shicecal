                        ...
                        <table class="table table-bordered fire-prevention-table-direct" style="table-layout: fixed !important; width: 100% !important;">
                            <tbody>
                                <tr style="display: flex !important; width: 100% !important;">
                                    <td class="detail-label" style="padding: .75rem .5rem !important; border: 1px solid #dee2e6 !important; display:flex !important; align-items:center !important; font-weight:600 !important; color:#495057 !important; background:#f8f9fa !important; box-sizing:border-box !important;">
                                        防火管理者
                                    </td>
                                    <td class="detail-value" style="padding:.75rem .5rem !important; border:1px solid #dee2e6 !important; border-left:none !important; display:flex !important; align-items:center !important; box-sizing:border-box !important;">
                                        {{ $fireDisasterInfo['fire_prevention']['fire_manager'] ?? '未設定' }}
                                    </td>
                                    <td class="detail-label" style="padding:.75rem .5rem !important; border:1px solid #dee2e6 !important; border-left:none !important; display:flex !important; align-items:center !important; font-weight:600 !important; color:#495057 !important; background:#f8f9fa !important; box-sizing:border-box !important;">
                                        訓練実施日
                                    </td>
                                    <td class="detail-value" style="padding:.75rem .5rem !important; border:1px solid #dee2e6 !important; border-left:none !important; display:flex !important; align-items:center !important; box-sizing:border-box !important;">
                                ...
                                <tr style="display: flex !important; width: 100% !important;">
                                    <td class="detail-label" style="padding:.75rem .5rem !important; border:1px solid #dee2e6 !important; border-top:none !important; display:flex !important; align-items:center !important; font-weight:600 !important; color:#495057 !important; background:#f8f9fa !important; box-sizing:border-box !important;">
                                        消防設備点検業者
                                    </td>
                                    <td class="detail-value" style="padding:.75rem .5rem !important; border:1px solid #dee2e6 !important; border-left:none !important; border-top:none !important; display:flex !important; align-items:center !important; box-sizing:border-box !important;">
                                        {{ $fireDisasterInfo['fire_prevention']['inspection_company'] ?? '未設定' }}
                                    </td>
                                    <td class="detail-label" style="padding:.75rem .5rem !important; border:1px solid #dee2e6 !important; border-left:none !important; border-top:none !important; display:flex !important; align-items:center !important; font-weight:600 !important; color:#495057 !important; background:#f8f9fa !important; box-sizing:border-box !important;">
                                        点検実施日
                                    </td>
                                    <td class="detail-value" style="padding:.75rem .5rem !important; border:1px solid #dee2e6 !important; border-left:none !important; border-top:none !important; display:flex !important; align-items:center !important; box-sizing:border-box !important;">
...
.security-disaster-container .security-disaster-subtabs{border-bottom:2px solid #dee2e6;margin-bottom:1.5rem;}
.security-disaster-container .security-disaster-subtabs .nav-link{border:none;border-bottom:3px solid transparent;background:none;color:#6c757d;font-weight:500;padding:.75rem 1.5rem;margin-bottom:-2px;transition:.3s;font-size:.95rem;}
.security-disaster-container .security-disaster-subtabs .nav-link:hover{color:#495057;background:#f8f9fa;}
.security-disaster-container .security-disaster-subtabs .nav-link.active{color:#fd7e14;border-bottom-color:#fd7e14;background:transparent;font-weight:600;}

.fire-disaster-equipment-sections .section-header h5{font-weight:600;}

.fire-disaster-basic-info-table,
.fire-prevention-table,
.disaster-prevention-table,
.fire-disaster-notes-table{margin-bottom:0;table-layout:fixed;}
...
.security-disaster-container #fire-disaster .fire-disaster-notes-table{
  width:100%!important;border-collapse:separate!important;border-spacing:0!important;table-layout:auto!important;
}
...
.security-disaster-container #fire-disaster .fire-disaster-basic-info-table tbody tr td{
  flex:1 1 50%!important;width:50%!important;max-width:50%!important;min-width:50%!important;
  display:flex!important;align-items:center!important;padding:.5rem!important;border:1px solid #dee2e6!important;border-right:none!important;box-sizing:border-box!important;
}
#fire-disaster .fire-disaster-basic-info-table tbody tr td:last-child,
.security-disaster-container #fire-disaster .fire-disaster-basic-info-table tbody tr td:last-child{border-right:1px solid #dee2e6!important;}
...
.security-disaster-container #fire-disaster .disaster-prevention-table tbody tr td[colspan="6"]{
  flex:1 1 100%!important;width:100%!important;max-width:100%!important;min-width:100%!important;
  display:flex!important;align-items:center!important;padding:.5rem!important;border:1px solid #dee2e6!important;box-sizing:border-box!important;
}
#fire-disaster .disaster-prevention-table tbody tr td:last-child,
.security-disaster-container #fire-disaster .disaster-prevention-table tbody tr td:last-child{border-right:1px solid #dee2e6!important;}
...
#fire-disaster .fire-disaster-notes-table td .detail-label{font-weight:600!important;color:#495057!important;margin-right:.5rem!important;white-space:nowrap!important;}
...
#fire-disaster .fire-disaster-notes-table td .detail-value{word-wrap:break-word!important;overflow-wrap:break-word!important;flex:1!important;}

/* ▼消防（6列）個別幅＝CSS変数 */
.fire-prevention-table-direct tr>td:nth-child(1){flex:0 0 var(--fd-col-1)!important;}
.fire-prevention-table-direct tr>td:nth-child(2){flex:0 0 var(--fd-col-2)!important;}
.fire-prevention-table-direct tr>td:nth-child(3){flex:0 0 var(--fd-col-3)!important;}
.fire-prevention-table-direct tr>td:nth-child(4){flex:0 0 var(--fd-col-4)!important;}
.fire-prevention-table-direct tr>td:nth-child(5){flex:0 0 var(--fd-col-5)!important;}
.fire-prevention-table-direct tr>td:nth-child(6){flex:0 0 var(--fd-col-6)!important;}

/* ▼備考（左=最左列幅、右=残り） */
.fd-notes-col-left{
  flex:0 0 var(--fd-col-1)!important;width:var(--fd-col-1)!important;max-width:var(--fd-col-1)!important;min-width:var(--fd-col-1)!important;
}
.fd-notes-col-right{
  flex:1 1 calc(100% - var(--fd-col-1))!important;width:calc(100% - var(--fd-col-1))!important;max-width:calc(100% - var(--fd-col-1))!important;min-width:calc(100% - var(--fd-col-1))!important;
}
</style>
@endpush
