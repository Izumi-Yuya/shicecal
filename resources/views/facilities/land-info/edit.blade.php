            ...
            <x-form.section title="関連書類" icon="fas fa-file-pdf" icon-color="danger"
                ...
                <div class="row g-3">
                    <div class="col-12 col-sm-6">
                        ...
                        <small id="lease_contract_help" class="form-text text-muted">PDFファイルのみ（最大10MB）</small>
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <small id="registry_help" class="form-text text-muted">PDFファイルのみ（最大10MB）</small>
