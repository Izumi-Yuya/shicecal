...
(function() {
    ...
    function initManager() {
        ...
        if (typeof ContractDocumentManager !== 'undefined') {
            ...
            console.error('[ContractDoc] ContractDocumentManager class not found');
            console.log('[ContractDoc] Available on window:', Object.keys(window).filter(k => k.includes('Document')));
        }
    }
