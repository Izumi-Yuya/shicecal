        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pdf.export.batch') }}" method="POST" id="pdfExportForm">
                        @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('pdf.export.secure.single', $facility) }}" 
                                                       class="btn btn-sm btn-success"
                                                       title="セキュアPDF出力">
                                                        <i class="fas fa-lock"></i>
                                                    </a>
                                                    <a href="{{ route('pdf.export.single', ['facility' => $facility, 'secure' => 0]) }}" 
