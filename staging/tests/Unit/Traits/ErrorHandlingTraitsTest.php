...
class ErrorHandlingTraitsTest extends TestCase
{
    public function test_controller_error_trait_methods_exist()
    {
        $trait = new class {
            ...
            public function testGetErrorCode($exception)
            {
                return $this->getErrorCode($exception);
            }

            public function testGetErrorMessage($exception)
            {
                return $this->getErrorMessage($exception);
            }

            public function testGetHttpStatusCode($exception)
            {
    ...
    public function test_service_error_trait_methods_exist()
    {
        $trait = new class {
            ...
            public function testValidateRequiredParams($params, $required, $operation = '')
            {
                return $this->validateRequiredParams($params, $required, $operation);
            }

            public function testExecuteWithErrorHandling($operation, $operationName, $context = [])
            {
