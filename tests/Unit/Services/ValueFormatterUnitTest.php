...
class ValueFormatterUnitTest extends TestCase
{
     ...
     * 空値判定のテスト
     */
    public function test_is_empty_判定が正しく動作する()
    {
        // null値
     ...
     * バッジクラス取得のテスト
     */
    public function test_get_badge_class_正しいクラスを返す()
    {
        // 成功系
     ...
     * 日本語日付フォーマット取得のテスト
     */
    public function test_get_japanese_date_format_正しいフォーマットを返す()
    {
     ...
     * 一括フォーマット機能のテスト
     */
    public function test_format_batch_複数値を正しく処理する()
    {
        $values = [
